...
<script type="text/html" id="tmpl-grunion-editor-inline">
	<div id="grunion-inline-wrap">
		<div class="grunion-modal wp-core-ui">
			<a href="#" class="form-settings-toggle"><span class="screen-reader-text"><?php esc_html_e( 'Form Settings', 'jetpack' ); ?></span></a>
			<h1 class="grunion-section-header grunion-form-settings-header">Settings</h1>
			...
			<h1 class="grunion-section-header grunion-fields-header">Form fields</h1>
